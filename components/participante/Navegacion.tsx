...
import { Camera, Home, ImagePlus, ListChecks, Trophy } from "lucide-react";
        ...
        {enlaces.map(({ href, etiqueta, Icono, principal }) => {
          ...
          return (
            <Link
              ...
              className={`relative flex min-h-12 min-w-14 flex-col items-center justify-center gap-0.5 rounded-xl text-[11px] font-extrabold ${
                principal
