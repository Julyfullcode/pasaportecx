          ...
          <article id={desafio.codigoQr === CODIGO_DESAFIO_CIERRE ? CODIGO_DESAFIO_CIERRE : undefined} key={desafio.id} className="tarjeta scroll-mt-5 overflow-hidden">
            <div className="flex flex-wrap items-center gap-3 p-4">
              ...
              {esPuntualidad ? (
                ...
                <>
                  {desafio.codigoQr === CODIGO_DESAFIO_CIERRE && <a href="/api/admin/cosecha?formato=horizontal-v2" className="boton-primario !min-h-10 !px-3 text-sm"><Download size={17} /> Descargar tarjetas PNG horizontales</a>}
