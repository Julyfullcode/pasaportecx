...
|---|---|---|
| Registro exitoso con nombre, empresa y foto | Abrir registro, completar nombre y empresa, adjuntar foto, aceptar datos y enviar. | Se crea el pasaporte y se otorgan los puntos configurados por registro. |
